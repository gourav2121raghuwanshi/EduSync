...
const Footer = () => {
    return (
        <div className='w-full bg-blue-700 mt-10 '>
            <div className='w-11/12 mx-auto text-white sm:p-8  px-4 py-2 flex flex-row justify-between items-center'>
                <span className='sm:text-xl text-lg'> © EduSync 2024.<br /> All rights reserved.</span>
